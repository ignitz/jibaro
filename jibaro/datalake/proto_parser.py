...
Comment = typing.NamedTuple(
    'Comment', [('content', str), ('tags', typing.Dict[str, typing.Any])])
Field = typing.NamedTuple('Field', [('comment', 'Comment'), ('type', str), (
    'key_type', str), ('val_type', str), ('name', str), ('number', int)])
Enum = typing.NamedTuple('Enum', [(
    'comment', 'Comment'), ('name', str), ('fields', typing.Dict[str, 'Field'])])
...
Service = typing.NamedTuple(
    'Service', [('name', str), ('functions', typing.Dict[str, 'RpcFunc'])])
RpcFunc = typing.NamedTuple(
    'RpcFunc', [('name', str), ('in_type', str), ('out_type', str), ('uri', str)])
            ...
            for token in tree.children:
                if isinstance(token, Comment):
                    ...
                    if token.type == "IDENT":
                        ...
                        comment = Comment(token.value, {})
            enumitems.append(Field(comment, 'enum', 'enum',
